import{r as Zt}from"./index-i_eL7tBi.js";import"./react-C4xND61i.js";const Jt=[{key:"trunk",label:"Trunk main",min:1,color:[.96,.49,.2]},{key:"main",label:"Branch main",min:.25,color:[.16,.55,.86]},{key:"lateral",label:"Lateral",min:0,color:[.28,.74,.82]}],ea=f=>f>=1?0:f>=.25?1:2,ke=14,jt=.95,ta=3.7,aa=3.5,ra=[{key:"storm",label:"Storm conduits",color:[.2,.62,.9]},{key:"sewer",label:"Sewer conduits",color:[.55,.38,.78]},{key:"unclassified",label:"Unclassified",color:[.45,.52,.58]}],oa=[0,13.2,15],Kt=`
